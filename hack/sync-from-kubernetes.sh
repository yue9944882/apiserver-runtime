...
# 3. rewrite the history on that branch to *only* include staging/src/github.com/pwittrock/apiserver-runtime
...
# this command rewrite git history to *only* include staging/src/github.com/pwittrock/apiserver-runtime
git filter-branch -f --subdirectory-filter staging/src/github.com/pwittrock/apiserver-runtime HEAD
