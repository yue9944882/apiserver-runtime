...
mkdir -p ${goPath}/src/github.com/pwittrock/apiserver-runtime
cp -R . ${goPath}/src/github.com/pwittrock/apiserver-runtime

pushd ${goPath}/src/github.com/pwittrock/apiserver-runtime
rm -rf vendor || true
...
mv ${goPath}/src/github.com/pwittrock/apiserver-runtime/vendor .
mv ${goPath}/src/github.com/pwittrock/apiserver-runtime/Godeps .
git add vendor
git add Godeps
