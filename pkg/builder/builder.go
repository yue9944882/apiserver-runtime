...
func (a *apiServer) WithOpenAPIDefinitions(
	name, version string, openAPI openapicommon.GetOpenAPIDefinitions) *apiServer {
...
func (a *apiServer) WithSchemeInstallers(fns ...func(*runtime.Scheme) error) *apiServer {
	b := &runtime.SchemeBuilder{}
	b.Register(fns...)
	b.AddToScheme(apiserver.Scheme)
	return a
}
...
func (a *apiServer) WithResource(obj resource.Object) *apiServer {
...
// resource if the object implements the resource.Defaulter interface.
func (a *apiServer) WithResourceAndStrategy(obj resource.Object, strategy rest.Strategy) *apiServer {
	gvr := obj.GetGroupVersionResource()
...
// resource if the object implements the resource.Defaulter interface.
func (a *apiServer) WithResourceAndHandler(obj resource.Object, sp rest.HandlerProvider) *apiServer {
	gvr := obj.GetGroupVersionResource()
...
//
// Consider using WithResource* or WithSubResource* functions instead.
func (a *apiServer) forGroupVersionResource(
	gvr schema.GroupVersionResource, obj resource.Object, sp rest.HandlerProvider) *apiServer {
...
func (a *apiServer) WithSubResource(
	parent resource.Object, subResourcePath string, request resource.Object) *apiServer {
...
func (a *apiServer) WithSubResourceAndStrategy(
	parent resource.Object, subResourcePath string, request resource.Object, strategy rest.Strategy) *apiServer {
	gvr := parent.GetGroupVersionResource()
	gvr.Resource = gvr.Resource + "/" + subResourcePath
...
// WithResourceAndHandler will automatically register version-specific defaulting for this version of the
// resource if the object implements the resource.Defaulter interface.
func (a *apiServer) WithSubResourceAndHandler(
	parent resource.Object, subResourcePath string, request resource.Object, sp rest.HandlerProvider) *apiServer {
	gvr := parent.GetGroupVersionResource()
...
//WithSchemeInstallers registers functions to install resource types into the Scheme.
func (a *apiServer) withGroupVersions(versions ...schema.GroupVersion) *apiServer {
...
func (a *apiServer) Execute() error {
	cmd, err := a.Build()
	if err != nil {
		return err
	}
