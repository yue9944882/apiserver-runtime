...
// WithAdditionalSchemesToBuild will
...
func (a *Server) register(obj resource.Object) {
	a.SchemeBuilder.Register(func(scheme *runtime.Scheme) error {
		gvr := obj.GetGroupVersionResource()
		scheme.AddKnownTypes(gvr.GroupVersion(), obj.New(), obj.NewList())
		if obj.IsInternalVersion() {
			internal := schema.GroupVersion{Group: gvr.Group, Version: runtime.APIVersionInternal}
			scheme.AddKnownTypes(internal, obj.New(), obj.NewList())
		}
		return nil
	})
}
