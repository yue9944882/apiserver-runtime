...
**Note:** go-get or vendor this package as `github.com/pwittrock/apiserver-runtime`.
...
`sample-apiserver` is synced from https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/pwittrock/apiserver-runtime.
...
```sh
go get -d github.com/pwittrock/apiserver-runtime
cd $GOPATH/src/github.com/pwittrock/apiserver-runtime  # assuming your GOPATH has just one entry
godep restore
```
...
`kubernetes/staging/src/github.com/pwittrock/apiserver-runtime` and its dependencies
